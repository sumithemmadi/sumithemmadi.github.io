...
const Skills = () => {
  ...
  const buttonStyle = {
    ...
    boxShadow: ".125rem .125rem .375rem 0 rgba(74, 45, 197, .04), .5rem .5625rem 1.625rem 0 rgba(74, 45, 197, .07), 1.375rem 1.5rem 5rem 0 rgba(74, 45, 197, .11)",
  ...
  return (
    <Section>
      <Container>
        <div>
          <h1 className="heading-style" id="skills">Skills</h1>
          <p style={paragraphStyle}>My technical skills in various categories.</p>
            ...
            <div style={categoriesStyle}>
              {skillsData.map(skill => (
                <button
                  ...
                  style={buttonStyle}
                >
                  <img src={skill.imgUrl} style={plLogo} alt={skill.name} width="32" height="32" />
                  <br></br>
                  <b>{skill.name}</b>
                </button>
              ))}
